...
constexpr const char CHEVRON_DOWN[]           = "\xef\x8a\x82";
constexpr const char CHEVRON_UP[]             = "\xef\x8a\x86";
...
constexpr const char PLUS_LG[]                = "\xef\x99\x8d";
constexpr const char DASH_LG[]                = "\xef\x98\xbb";
constexpr const char TRASH[]                  = "\xef\x9e\x8b";
constexpr const char ARROWS_COLLAPSE[]        = "\xef\x85\x8b";
constexpr const char BOX_ARROW_UP_RIGHT[]     = "\xef\x87\x85";
constexpr const char BOX_ARROW_IN_DOWN_LEFT[] = "\xef\x86\xba";
constexpr const char WINDOW_PLUS[]            = "\xef\x9b\x90";
constexpr const char CHEVRON_DOUBLE_RIGHT[]   = "\xef\x8a\x80";
constexpr const char THREE_DOTS_VERTICAL[]    = "\xef\x97\x93";
}  // namespace icon
