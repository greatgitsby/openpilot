...
static_assert(IMGUI_VERSION_NUM == 19263, "Update the Cabana tab extension when upgrading ImGui");
...
bool    ImGui::BeginTabBarEx(ImGuiTabBar* tab_bar, const ImRect& tab_bar_bb, ImGuiTabBarFlags flags)
{
    ...
    // Cabana uses the same scrolling controls for widget and native dock tabs.
    flags = (flags & ~(ImGuiTabBarFlags_FittingPolicyMask_ | ImGuiTabBarFlags_NoTabListScrollingButtons)) | ImGuiTabBarFlags_FittingPolicyScroll;
...
{
    layoutTabScrollButtons(tab_bar);
    return NULL;
}
