...
enum Pane { PaneMessages = 0, PaneBits, PaneSignals, PaneLogs, PaneVideo, PaneCharts, kPaneCount };
inline constexpr const char *kPaneIniKeys[kPaneCount] = {"MessagesVisible", "BitsVisible", "SignalsVisible", "LogsVisible", "VideoVisible", "ChartsVisible"};
...
struct MainWindowState {
  ...
  bool pane_visible[kPaneCount] = {true, true, true, true, true, true};
};
