...
class MiciHomeLayout(Widget):
  def __init__(self):
    ...
    # Tesla charge, rendered into the status bar next to the wifi icon
    self._charge_label = UnifiedLabel("", font_size=36, font_weight=FontWeight.ROMAN, max_width=200, wrap_text=False)
